// test5.8.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
int mouseROI()
{
	cv::Mat srcMat = imread("E:\\Picture\\lena.jpg");
	cv::Mat dstMat;
...
int dftDemo() {
	...
	cv::Mat srcMat = imread("E:\\Picture\\lena.jpg", 0);
...
{
	cv::Mat dst;
	cv::Mat src = imread("E:\\Picture\\lena.jpg", 0);
